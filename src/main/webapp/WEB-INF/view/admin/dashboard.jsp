               ...
               <div class="row">
                  <div class="col-lg-3 col-6">
                     <div class="small-box bg-info">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/order/list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                     </div>
                  </div>
                  <div class="col-lg-3 col-6">
                     <div class="small-box bg-warning">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/order/list?phone=&statusID=1&filter=1" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                     </div>
                  </div>
                  <div class="col-lg-3 col-6">
                     <div class="small-box bg-teal">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/user/list?roleID=2&fullName=&phone=&email=&address=" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                     </div>
                  </div>
                  <div class="col-lg-3 col-6">
                     <div class="small-box bg-danger">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/product/list?name=&newProduct=all&price=0%3B10000&bestSaler=all&category=-1&stock=0%3B5" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <tbody>
                           <c:forEach items="${lastOrders}" var="order">
                              <tr>
                                 ...
                                 <td>
                                    <fmt:formatNumber value = "${ order.discount }" type = "number" maxFractionDigits = "0"/>
                                    VND
                                 </td>
                                 <td>
                                    ${ order.status.name }
